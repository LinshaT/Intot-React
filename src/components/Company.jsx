        ...
        <div className="container">
            <div className="row deck">
                  <div className="col-md-4">
                        <div className="card">
                            <img src="assets/images/images/card-img-1.png" alt="card1"></img>
                ...
                <div className="col-md-4">
                    <div className="card">
                        <img src="assets/images/images/card-img-2.png" alt="card1"></img>
                ...
                <div className="col-md-4">
                    <div className="card">
                    <img src="assets/images/images/card-img-3.png" alt="card1"></img>
